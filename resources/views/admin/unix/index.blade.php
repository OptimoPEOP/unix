...
<div class="row">
  <div class="col-xs-12">
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Darkmode Color Config <span class="label label-success" style="margin-left: 5px;font-size: 12px;">Default</span></h3>
        </div>
      <div class="box-body">
            <div class="row">
                        <div>
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <div>
                                <input type="text" class="form-control" id="pcolor" name="pcolor" value="@isset($setting_data['pcolor']){{$setting_data['pcolor']}}@else #1f1d2b @endisset" required="">
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <div>
                                <input type="text" class="form-control" id="scolor" name="scolor" value="@isset($setting_data['scolor']){{$setting_data['scolor']}}@else #1f1d2b @endisset" required="">
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <div>
                                <input type="text" class="form-control" id="tcolor" name="tcolor" value="@isset($setting_data['tcolor']){{$setting_data['tcolor']}}@else #1f1d2b @endisset" required="">
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <div>
                                <input type="text" class="form-control" id="text-color" name="textcolor" value="@isset($setting_data['textcolor']){{$setting_data['textcolor']}}@else #1f1d2b @endisset" required="">
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <div>
                                <input type="text" class="form-control" id="active-text-color" name="activetextcolor" value="@isset($setting_data['activetextcolor']){{$setting_data['activetextcolor']}}@else #1f1d2b @endisset" required="">
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <div>
                                <input type="text" class="form-control" id="button-color" name="buttoncolor" value="@isset($setting_data['buttoncolor']){{$setting_data['buttoncolor']}}@else #1f1d2b @endisset" required="">
          ...
          <div><a onclick="ResetToDefaultDark()" class="btn btn-sm btn-primary pull-left" style="background: rgb(207, 65, 65); border-color: rgb(207, 65, 65);">Reset to Default</a></div>
                ...
                <div class="row">
                            <div>
                                ...
                                <div class="form-group col-md-4">
                                  <label class="control-label">Primary Background Color</label>
                                  <div>
                                    <input type="text" class="form-control" id="Light_pcolor" name="Light_pcolor" value="@isset($setting_data['Light_pcolor']){{$setting_data['Light_pcolor']}}@else #f0f2fa @endisset" required/>
                                    <p class="text-muted"><small>This is the primary background template color.</small></p>
                                  </div>
                                </div>
                                <div class="form-group col-md-4">
                                  <label class="control-label">Secondary Background Color</label>
                                  <div>
                                    <input type="text" class="form-control" id="Light_scolor" name="Light_scolor" value="@isset($setting_data['Light_scolor']){{$setting_data['Light_scolor']}}@else #ffffff @endisset" required/>
                                    <p class="text-muted"><small>This is the Secondary background template color.</small></p>
                                  </div>
                                </div>
                                <div class="form-group col-md-4">
                                  <label class="control-label">Tertiary Background Color</label>
                                  <div>
                                    <input type="text" class="form-control" id="Light_tcolor" name="Light_tcolor" value="@isset($setting_data['Light_tcolor']){{$setting_data['Light_tcolor']}}@else #eff0f6 @endisset" required/>
                                    <p class="text-muted"><small>This is the Tertiary background template color.</small></p>
                                  </div>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                  <label class="control-label">Text Color</label>
                                  <div>
                                    <input type="text" class="form-control" id="Light_textcolor" name="Light_textcolor" value="@isset($setting_data['Light_textcolor']){{$setting_data['Light_textcolor']}}@else #767676 @endisset" required/>
                                    <p class="text-muted"><small>This is the color of the text.</small></p>
                                  </div>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                  <label class="control-label">Active Text Color</label>
                                  <div>
                                    <input type="text" class="form-control" id="Light_activetextcolor" name="Light_activetextcolor" value="@isset($setting_data['Light_activetextcolor']){{$setting_data['Light_activetextcolor']}}@else black @endisset" required/>
                                    <p class="text-muted"><small>This is the color displayed when buttons are active or selected.</small></p>
                                  </div>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                  ...
                                  <div>
                                    <select class="form-control" name="mode" required>
                                      <option value="@isset($setting_data['mode']){{$setting_data['mode']}} @endisset" selected="">Currently set to ->@isset($setting_data['mode'])@if($setting_data['mode'] == "true") Enabled @else Disabled  @endif
                                        @endisset</option>
        ...
        <div class="box-footer">
          ...
          <div><a onclick="ResetToDefaultLight()" class="btn btn-sm btn-primary pull-left" style="background: rgb(207, 65, 65); border-color: rgb(207, 65, 65);">Reset to Default</a></div>
        </div>
...
function ResetToDefaultLight() {
  ...
  document.getElementById("Light_pcolor").value = "#f0f2fa";
  document.getElementById("Light_scolor").value = "#ffffff";
  document.getElementById("Light_tcolor").value = "#eff0f6";

  document.getElementById("Light_textcolor").value = "#767676";
  document.getElementById("Light_activetextcolor").value = "black";
