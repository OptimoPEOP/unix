...
<div id="alert" class="alert alert-info alert-white rounded" style="background: @isset($setting_data['abackgroundcolor']){{$setting_data['abackgroundcolor']}}@else white @endisset;">
    ...
    <br>ACTIVATE YOUR LICENSE IN THE UNIX ADMIN SECTION TO ENABLE THE UNIX THEME!
</div>
...
<head>
    ...
    <body style="background: var(--theme-bg);">
        ...
        <style>:root{--theme-bg: transparent!important;     --theme-primary-bg: #0000004a!important; --theme-secondary-bg: #0000005e!important; }html{background-image: url('@isset($setting_data['main-bg-img']){{$setting_data['main-bg-img']}}@else https://wallpaperaccess.com/full/2002264.png @endisset');background-size: cover;} div#FileDropdown, .style-module_1RnhIT0w {background: white !important;}</style>
        @else @endif @endisset
    ...
    <path d="M12,5V4c0-2.209-1.791-4-4-4S4,1.791,4,4v1c0,2.209,1.791,4,4,4S12,7.209,12,5z" style="
        fill: #FFFF;"/>
                        ...
                        <a class="sidebar-link" href="/account/ssh">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="524.931px" color="#353340" viewBox="0 0 524.931 524.93" style="enable-background:new 0 0 524.931 524.93;" xml:space="preserve"
                                fill="#FFFF">
    <g>
        <g>
            ...
            <div class="wrapper">
                <div class="header">
                    ...
                    @isset($setting_data['mode'])@if($setting_data['mode'] == "false") 
                    @else 
                    <a href="{{route('unix.mode')}}" class="theme-toggle">
                    ...
                    @endif @endisset  
                        ...
                        @endisset<i class='bx bxs-chevron-down'></i>
                            </div>
                        <div class="dropdown-content">
                        <a href="/account"><i class='bx bxs-user' ></i> Account</a>
                        <a href="/account/activity"><i class='bx bxs-user-voice' ></i> Account Activity</a>
                        @if(Auth::user()->root_admin) <a href="/admin"><i class='bx bxs-cog' ></i> Admin</a>@endif
                        <a onclick="logout()"><i class='bx bxs-right-arrow-alt' ></i> Logout</a>
                        </div>
                    </div>
                    </div>
                </div>
    ...
    .SubNavigation-sc-lfuaoi-0.jZPsWO.fade-appear-done.fade-enter-done {
        display: none;
    }
    @else @endif @endisset
    ...
    @else @endif @endisset
      ...
      @if(Cache::has( Auth::user()->id.'_mode') AND Cache::get( Auth::user()->id.'_mode') == "light")

    --theme-bg: @isset($setting_data['Light_pcolor']){{$setting_data['Light_pcolor']}}@else #1f1d2b @endisset; ;
    
    /* Primary content background-color DEFAULT #0000000d */
    --theme-primary-bg: @isset($setting_data['Light_scolor']){{$setting_data['Light_scolor']}}@else #0000000d @endisset; ;
  
    /* Secondary content background-color DEFAULT #0000001a */
    --theme-secondary-bg: @isset($setting_data['Light_tcolor']){{$setting_data['Light_tcolor']}}@else #0000001a @endisset; ;
  
  
    /* side-menu text color DEFAULT #808191 */
    --body-color: @isset($setting_data['Light_textcolor']){{$setting_data['Light_textcolor']}}@else #808191 @endisset; ;
  
    /* side-menu text color DEFAULT #808191 */
    --body-active-color: @isset($setting_data['Light_activetextcolor']){{$setting_data['Light_activetextcolor']}}@else white @endisset;;
    ...
    .sidebar .logo-expand, .sidebar-link:hover, .sidebar-link.is-active,{
